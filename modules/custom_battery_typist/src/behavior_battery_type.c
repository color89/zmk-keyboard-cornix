 ...
 * ---------------------------------------------------------------- */
#define FORMAT_PREFIX   "Batt -> A"
#define FORMAT_MIDDLE   "% B"
...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    int left_bat = get_0_battery();
    int right_bat = get_1_battery();
